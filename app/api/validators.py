...
async def check_charity_project_exists(
    ...
    """Проверяет наличие благотворительного проекта."""
...
async def check_name_duplicate(
    ...
    """Проверяет уникальность названия благотворительного проекта."""
...
async def check_project_was_closed(
    ...
    """Проверяет, закрыт ли благотворительный проект."""
...
async def check_project_was_invested(
    ...
    """Проверяет пожертвования в благотворительный проект."""
...
async def check_correct_full_amount_for_update(
    ...
    """Проверяет возможность обновления суммы пожертвования."""
